...
| NSNumber | NSString |
| NSString/NSNumber | C number (BOOL, int, float, NSUInteger, UInt64, …) <br> NaN and Inf will be ignored |
| NSString | NSDate parsed with these formats:  |
| yyyy-MM-dd | yyyy-MM-dd HH:mm:ss <br> yyyy-MM-dd'T'HH:mm:ss <br> yyyy-MM-dd’T’HH:mm:ssZ <br> EEE MMM dd HH:mm:ss Z yyyy |
| NSDate | NSString formatted with ISO8601: <br>  "YYYY-MM-dd'T’HH:mm:ssZ" |
